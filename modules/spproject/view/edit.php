		...
		<form method='post' enctype="multipart/form-data">
			<div class="form-group">
				...
				<input type="text" name="name" class="form-control" id="inputname"
					placeholder="项目名称" value="<?php echo $spproject->name;?>" required>
			</div>
			<div class="form-group">
				<label name="pic_url" for="inputpic_url" class="control-label">广告宣传图</label>
				<img alt="广告宣传图" src="<?php echo $spproject->pic_url;?>"> 
				<input type="file" name="pic_url" id="inputpic_url" />
			...
			<div class="form-group">
				<label name="phone_or_400" for="inputphone_or_400"
					...
					placeholder="招商电话" value="<?php echo $spproject->phone_or_400;?>">
			</div>
			<div class="form-group">
				...
				<textarea name="db_shangqiao_code" rows="5" class="form-control"
					id="inputdb_shangqiao_code" placeholder="百度商桥代码"><?php echo $spproject->db_shangqiao_code;?></textarea>
			</div>
